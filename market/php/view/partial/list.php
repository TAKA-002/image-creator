<div class="container max-w-7xl mx-auto mt-8">
  ...
  <div class="flex flex-col">
    <div class="overflow-x-scroll">
      <div class="inline-block min-w-full overflow-x-scroll align-middle border-b border-gray-200 shadow sm:rounded-lg">
        <table class="min-w-full">
          <thead>
            <tr>
              ...
              <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">カラー</th>
