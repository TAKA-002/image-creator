    ...
    <div class="flex items-start justify-between">
      <div class="h-screen hidden lg:block shadow-lg relative w-80">
        <div class="bg-white h-full dark:bg-gray-700">
          <div class="flex items-center justify-start pt-6 ml-8">
            <p class="font-bold dark:text-white text-xl">Image Creator</p>
          </div>
          <!-- サイドバー -->
          <nav class="mt-6">
            <div>
              ...
              <a class="w-full text-gray-400 flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start hover:text-gray-800 border-l-4 border-transparent" href="#">
                ...
                <span class="mx-2 text-sm font-normal">マーケット興味津々 - 注目予定</span>
              </a>
              <!-- <a class="w-full text-gray-400 flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start hover:text-gray-800 border-l-4 border-transparent" href="#">
                <span class="text-left">
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="flex flex-col w-full md:space-y-4">
        ...
        <div class="overflow-auto h-screen pb-24 px-4 md:px-6">
          <h1 class="text-4xl font-semibold text-gray-800 dark:text-white">マーケット興味津々 - 注目予定</h1>
          <h2 class="text-md text-gray-400">https://www3.nhk.or.jp/news/special/stockmarket/</h2>
              ...
              <div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
                <div id="capture" class="list">
                  <div class="list__header">
                    <h3 class="list__header-text">
                      注目予定<span>(いずれも日本時間)</span>
                    </h3>
                  </div>
